 ...
 * Sem charset devido ao bug do JBPM que quando passa o charset no header ele não indentifica como JSON
 * 
 * @author rodrigo.hiemer
 *
 */
public class JsonResponseSemCharset {

	/***
	 * Constrói uma resposta com um cabeçalho Content-Type
	 * 
	 * @param status
	 *            Status HTTP
	 * @param entity
	...
	/***
	 * Constrói uma resposta com um cabeçalho 
