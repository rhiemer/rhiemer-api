...
import br.com.rhiemer.api.jpa.criteria.filtros.exists.ExistsCriteriaJPA;
import br.com.rhiemer.api.jpa.criteria.filtros.exists.NotExistsCriteriaJPA;
...
public interface IBuilderFiltrosJPA<T> extends IBuilderMetodosJPA {
	...
	default MetodosJuncaoJPAOr<T> or() {
		...
		adicionarFiltro(new ParametrizarCriteriaJPAParametro().setObjeto(objeto));
		return objeto;
	}
	...
	default IBuilderFiltrosJPA<T> equal(String atributo, Object... values) {
		adicionarFiltro(new ParametrizarCriteriaJPAParametro().setClasse(EqualsCriteriaJPA.class).setAtributo(atributo)
				.setValues(values));
		return this;
	}

	default IBuilderFiltrosJPA<T> equal(String atributo, ParametroCriteriaJPADto parametos, Object... values) {
		adicionarFiltro(new ParametrizarCriteriaJPAParametro(parametos).setClasse(EqualsCriteriaJPA.class)
				.setAtributo(atributo).setValues(values));
		return this;
	}

	default IBuilderFiltrosJPA<T> equalAtribute(Object value, Attribute... atributes) {
		adicionarFiltro(new ParametrizarCriteriaJPAParametro().setClasse(EqualsCriteriaJPA.class)
	...
	default IBuilderFiltrosJPA<T> notEqual(String atributo, Object... values) {
		adicionarFiltro(new ParametrizarCriteriaJPAParametro().setClasse(NotEqualsCriteriaJPA.class)
				.setAtributo(atributo).setValues(values));
		return this;
	}

	default IBuilderFiltrosJPA<T> notEqual(String atributo, ParametroCriteriaJPADto parametos, Object... values) {
		adicionarFiltro(new ParametrizarCriteriaJPAParametro(parametos).setClasse(NotEqualsCriteriaJPA.class)
				.setAtributo(atributo).setValues(values));
		return this;
	}
	...
	default IBuilderFiltrosJPA<T> like(String atributo, Object... values) {
		adicionarFiltro(new ParametrizarCriteriaJPAParametro().setClasse(LikeCriteriaJPA.class).setAtributo(atributo)
				.setValues(values));
		return this;
	}

	default IBuilderFiltrosJPA<T> like(String atributo, ParametroCriteriaJPADto parametos, Object... values) {
		adicionarFiltro(new ParametrizarCriteriaJPAParametro(parametos).setClasse(LikeCriteriaJPA.class)
				.setAtributo(atributo).setValues(values));
		return this;
	}

	default IBuilderFiltrosJPA<T> likeAtribute(Object value, Attribute... atributes) {
		adicionarFiltro(new ParametrizarCriteriaJPAParametro().setClasse(LikeCriteriaJPA.class).setAttributes(atributes)
	...
	default IBuilderFiltrosJPA<T> iLike(String atributo, Object... values) {
		adicionarFiltro(new ParametrizarCriteriaJPAParametro().setClasse(ILikeCriteriaJPA.class).setAtributo(atributo)
				.setValues(values));
		return this;
	}

	default IBuilderFiltrosJPA<T> iLike(String atributo, ParametroCriteriaJPADto parametos, Object... values) {
		adicionarFiltro(new ParametrizarCriteriaJPAParametro(parametos).setClasse(ILikeCriteriaJPA.class)
				.setAtributo(atributo).setValues(values));
		return this;
	}

	default IBuilderFiltrosJPA<T> iLikeAtribute(Object value, Attribute... atributes) {
		adicionarFiltro(new ParametrizarCriteriaJPAParametro().setClasse(ILikeCriteriaJPA.class)
				.setAttributes(atributes).setValues(new Object[] { value }));
		return this;
	}
	...
	default IBuilderFiltrosJPA<T> in(String atributo, Object... values) {
		adicionarFiltro(new ParametrizarCriteriaJPAParametro().setClasse(InCriteriaJPA.class).setAtributo(atributo)
				.setValues(values));
		return this;
	}

	default IBuilderFiltrosJPA<T> in(String atributo, ParametroCriteriaJPADto parametos, Object... values) {
		adicionarFiltro(new ParametrizarCriteriaJPAParametro(parametos).setClasse(InCriteriaJPA.class)
				.setAtributo(atributo).setValues(values));
		return this;
	}

	default IBuilderFiltrosJPA<T> inAtribute(Object value, Attribute... atributes) {
		adicionarFiltro(new ParametrizarCriteriaJPAParametro().setClasse(InCriteriaJPA.class).setAttributes(atributes)
				.setValues(new Object[] { value }));
		return this;
	}
	...
	default IBuilderFiltrosJPA<T> notIn(String atributo, Object... values) {
		adicionarFiltro(new ParametrizarCriteriaJPAParametro().setClasse(NotInCriteriaJPA.class).setAtributo(atributo)
				.setValues(values));
		return this;
	}

	default IBuilderFiltrosJPA<T> notIn(String atributo, ParametroCriteriaJPADto parametos, Object... values) {
		adicionarFiltro(new ParametrizarCriteriaJPAParametro(parametos).setClasse(NotInCriteriaJPA.class)
				.setAtributo(atributo).setValues(values));
		return this;
	}

	default IBuilderFiltrosJPA<T> notInAtribute(Object value, Attribute... atributes) {
		adicionarFiltro(new ParametrizarCriteriaJPAParametro().setClasse(NotInCriteriaJPA.class)
				.setAttributes(atributes).setValues(new Object[] { value }));
		return this;
	}
	...
	default IBuilderFiltrosJPA<T> maiorQue(String atributo, Object... values) {
		adicionarFiltro(new ParametrizarCriteriaJPAParametro().setClasse(MaiorQueCriteriaJPA.class)
				.setAtributo(atributo).setValues(values));
		return this;
	}

	default IBuilderFiltrosJPA<T> maiorQue(String atributo, ParametroCriteriaJPADto parametos, Object... values) {
		adicionarFiltro(new ParametrizarCriteriaJPAParametro(parametos).setClasse(MaiorQueCriteriaJPA.class)
				.setAtributo(atributo).setValues(values));
		return this;
	}
	...
	default IBuilderFiltrosJPA<T> maiorQueOuIgual(String atributo, Object... values) {
		adicionarFiltro(new ParametrizarCriteriaJPAParametro().setClasse(MaiorQueOuIgualCriteriaJPA.class)
				.setAtributo(atributo).setValues(values));
		return this;
	}
	...
	default IBuilderFiltrosJPA<T> maiorQueOuIgual(String atributo, ParametroCriteriaJPADto parametos,
			Object... values) {
		adicionarFiltro(new ParametrizarCriteriaJPAParametro(parametos).setClasse(MaiorQueOuIgualCriteriaJPA.class)
				.setAtributo(atributo).setValues(values));
		return this;
	}
	...
	default IBuilderFiltrosJPA<T> menorQue(String atributo, Object... values) {
		adicionarFiltro(new ParametrizarCriteriaJPAParametro().setClasse(MenorQueCriteriaJPA.class)
				.setAtributo(atributo).setValues(values));
		return this;
	}

	default IBuilderFiltrosJPA<T> menorQue(String atributo, ParametroCriteriaJPADto parametos, Object... values) {
		adicionarFiltro(new ParametrizarCriteriaJPAParametro(parametos).setClasse(MenorQueCriteriaJPA.class)
				.setAtributo(atributo).setValues(values));
		return this;
	}
	...
	default IBuilderFiltrosJPA<T> menorQueOuIgual(String atributo, Object... values) {
		adicionarFiltro(new ParametrizarCriteriaJPAParametro().setClasse(MenorQueOuIgualCriteriaJPA.class)
				.setAtributo(atributo).setValues(values));
		return this;
	}
	...
	default IBuilderFiltrosJPA<T> menorQueOuIgual(String atributo, ParametroCriteriaJPADto parametos,
			Object... values) {
		adicionarFiltro(new ParametrizarCriteriaJPAParametro(parametos).setClasse(MenorQueOuIgualCriteriaJPA.class)
				.setAtributo(atributo).setValues(values));
		return this;
	}
	...
	default IBuilderFiltrosJPA<T> isNull(String... atributo) {
		...
		_atributos.forEach(x -> adicionarFiltro(new ParametrizarCriteriaJPAParametro()
	...
	default IBuilderFiltrosJPA<T> isNull(ParametroCriteriaJPADto parametos, String... atributo) {
		List<String> _atributos = Helper.convertArgs(atributo);
		_atributos.forEach(x -> adicionarFiltro(new ParametrizarCriteriaJPAParametro(parametos)
				.setClasse(IsNullCriteriaJPA.class).setAtributo(x).setValues(new Object[] { 0 })));
		return this;
	}

	default IBuilderFiltrosJPA<T> isNullAtribute(Attribute... atributes) {
		adicionarFiltro(new ParametrizarCriteriaJPAParametro().setClasse(IsNullCriteriaJPA.class)
	...
	default IBuilderFiltrosJPA<T> isNullAtribute(ParametroCriteriaJPADto parametos, Attribute... atributes) {
		adicionarFiltro(new ParametrizarCriteriaJPAParametro(parametos).setClasse(IsNullCriteriaJPA.class)
				.setAttributes(atributes).setValues(new Object[] { 0 }));
		return this;
	}
	...
	default IBuilderFiltrosJPA<T> isNotNullAtribute(Attribute... atributes) {
		adicionarFiltro(new ParametrizarCriteriaJPAParametro().setClasse(IsNotNullCriteriaJPA.class)
				.setAttributes(atributes).setValues(new Object[] { 0 }));
		return this;
	}

	default IBuilderFiltrosJPA<T> isNotNullAtribute(ParametroCriteriaJPADto parametos, Attribute... atributes) {
		adicionarFiltro(new ParametrizarCriteriaJPAParametro(parametos).setClasse(IsNotNullCriteriaJPA.class)
				.setAttributes(atributes).setValues(new Object[] { 0 }));
		return this;
	}

	default IBuilderFiltrosJPA<T> between(String atributo, Object filtro1, Object filtro2) {
		adicionarFiltro(new ParametrizarCriteriaJPAParametro().setClasse(BetweenValueCriteriaJPA.class)
	...
	default IBuilderFiltrosJPA<T> between(String atributo, Object filtro1, Object filtro2,
		...
		adicionarFiltro(new ParametrizarCriteriaJPAParametro(parametos).setClasse(BetweenValueCriteriaJPA.class)
				.setAtributo(atributo).setFiltro1(filtro1).setFiltro2(filtro2));
		return this;
	}
	...
	default IBuilderFiltrosJPA<T> betweenCampo(String path1, String path2, Object filtro) {
		adicionarFiltro(new ParametrizarCriteriaJPAParametro().setClasse(BetweenAtributoCriteriaJPA.class)
	...
	default IBuilderFiltrosJPA<T> betweenCampo(String path1, String path2, Object filtro,
			ParametroCriteriaJPADto parametos) {
		adicionarFiltro(new ParametrizarCriteriaJPAParametro(parametos).setClasse(BetweenAtributoCriteriaJPA.class)
				.setPath1(path1).setPath2(path2).setValues(new Object[] { filtro }));
		return this;
	}
	...
	default IBuilderFiltrosJPA<T> exists(SubQueryRetornoDTO subQueryRetornoDTO) {
	...
	default IBuilderFiltrosJPA<T> notExists(SubQueryRetornoDTO subQueryRetornoDTO) {
		adicionarFiltro(new ParametrizarCriteriaJPAParametro().setClasse(NotExistsCriteriaJPA.class)
				.setSubQueryRetornoDTO(subQueryRetornoDTO));
		return this;
	}
